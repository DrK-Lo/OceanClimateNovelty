...
## Basic Code for calculating and mapping climatic novelty using the sigma dissimilarity metric. 
    #NB:  For simplicity, this code calculates dissimilarity based on the 
    #interannual climatic variability of the closest CRU TS3.23 weather station. 
    #The results in the manuscript are the inverse-distance-weigthed average of novelty 
    #calculated from the nearest four weather stations, which are specifed in the grid4nn_NAnaec8.csv file     
...
# edits added by Katie Lotterhos Oct 2018
