...
# 1800 to 2000  
  ...
  contour(x,y, setup_plot(z_1800), nlevels=2, add=TRUE, col=get_cols("blue")[c(4,2)], drawlabels=FALSE)
  contour(x,y, setup_plot(z_2000), nlevels=2, add=TRUE, col=get_cols("goldenrod")[c(5,3)], drawlabels=FALSE)
...
# 2000 to 2100_8.5  
  ...
  contour(x,y, setup_plot(z_2100_8.5), nlevels=2, add=TRUE, col=get_cols("darkmagenta")[c(4,2)], drawlabels=FALSE)
  contour(x,y, setup_plot(z_2000), nlevels=2, add=TRUE, col=get_cols("goldenrod")[c(5,3)], drawlabels=FALSE)
...
# 1800 to 2000  PH
  ...
  contour(xb,yb, setup_plot(z_1800b), nlevels=2, add=TRUE, col=get_cols("blue")[c(4,2)], drawlabels=FALSE)
  contour(xb,yb, setup_plot(z_2000b), nlevels=2, add=TRUE, col=get_cols("goldenrod")[c(5,3)], drawlabels=FALSE)
  text(0, 8.9, "C", cex=2)
  #text(20, 7.5, "1800 disappearing in 2000", col="dodgerblue4")  
  #lines(c(20,25), c(7, 4.6), lwd=3, col="dodgerblue4")
  #lines(c(20,5.3), c(7, 4.1), lwd=3, col="dodgerblue4")
...
# 2000 to 2100_8.5  PH
  ...
  contour(xb,yb, setup_plot(z_2100_8.5b), nlevels=2, add=TRUE, col=get_cols("darkmagenta")[c(4,2)], drawlabels=FALSE)
  contour(xb,yb, setup_plot(z_2000b), nlevels=2, add=TRUE, col=get_cols("goldenrod")[c(5,3)], drawlabels=FALSE)
  #text(20, 6.5, "2000 disappearing in\n2100 RCP 8.5", col="goldenrod4")  
  text(0, 8.9, "D", cex=2)
