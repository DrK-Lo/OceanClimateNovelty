...
head(dat_Nov)
for_liqing <- data.frame(No=dat_Nov$No, lat=dat_Nov$lat,
                         long=dat_Nov$long,
...
for_liqing_Md <- data.frame(No=dat_Nov$No,
                            lat=dat_Nov$lat,long=dat_Nov$long,
                            A=dat_Nov$NN.Mdist_today_1800, 
                            B=dat_Nov$NN.Mdist_1800_today, 
                            C=dat_Nov$NN.Mdist_2100_4.5_today, 
                            D=dat_Nov$NN.Mdist_today_2100_4.5, 
                            E=dat_Nov$NN.Mdist_2100_8.5_today, 
                            F=dat_Nov$NN.Mdist_today_2100_8.5)
write.csv(for_liqing_Md,  paste0(results_dir,"MD_Hem_plot2.csv"), row.names=FALSE)
```
